...
! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).ApexCharts = e() }(this, function() {
        ...
        f = function() {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    var T = this.drawPath({ d: e, stroke: o, strokeWidth: l, fill: c, fillOpacity: 1, classes: x, strokeLinecap: h, strokeDashArray: E });
                ...
                value: function(t) {
                    var e, i = this.w,
                        ...
                        c = t.foreColor,
                        d = t.opacity;
                    return void 0 === n && (n = ""), r || (r = "start"), c || (c = i.config.chart.foreColor), l = l || i.config.chart.fontFamily, h = h || "regular", (e = Array.isArray(n) ? i.globals.dom.Paper.text(function(t) { for (var e = 0; e < n.length; e++) t.tspan(n[e]) }) : i.globals.dom.Paper.plain(n)).attr({ x: s, y: a, "text-anchor": r, "dominant-baseline": "auto", "font-size": o, "font-family": l, "font-weight": h, fill: c, class: (t.cssClass, t.cssClass) }), e.node.style.fontFamily = l, e.node.style.opacity = d, e
                }
            }, {
                key: "addTspan",
                value: function(t, e, i) {
    ...
    var p = { name: "en", options: { months: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], shortMonths: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], days: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], shortDays: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], toolbar: { exportToSVG: "Download SVG", exportToPNG: "Download PNG", menu: "Menu", selection: "Selection", selectionZoom: "Selection Zoom", zoomIn: "Zoom In", zoomOut: "Zoom Out", pan: "Panning", reset: "Reset Zoom" } } },
                ...
                value: function(t, e, i) {
                    ...
                    if (!(r < 0 || r > s.globals.gridWidth)) {
                        ...
                        var g = "top" === t.label.position ? -3 : s.globals.gridHeight,
                            f = this.graphics.drawText({ x: r + t.label.offsetX, y: g + t.label.offsetY, text: o, textAnchor: t.label.textAnchor, fontSize: t.label.style.fontSize, fontFamily: t.label.style.fontFamily, foreColor: t.label.style.color, cssClass: "apexcharts-xaxis-annotation-label " + t.label.style.cssClass });
        ...
        P = function() {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    var k = a / y.config.chart.animations.animateGradually.delay * (y.config.chart.animations.speed / y.globals.dataPoints) / 2.4,
                        A = w.renderPaths({ i: n, j: a, realIndex: e, pathFrom: r, pathTo: o, stroke: s, strokeWidth: l, strokeLineCap: y.config.stroke.lineCap, fill: i, animationDelay: k, initialSpeed: y.config.chart.animations.speed, dataChangeSpeed: y.config.chart.animations.dynamicAnimation.speed, className: "apexcharts-".concat(v, "-area") });
            ...
            }, { key: "initialPositions", value: function() { var t, e, i, s, a, n, r, o, l = this.w; return this.isHorizontal ? (a = (i = l.globals.gridHeight / l.globals.dataPoints) / this.seriesLen, l.globals.isXNumeric && (a = (i = l.globals.gridHeight / this.totalItems) / this.seriesLen), a = a * parseInt(this.barOptions.barHeight) / 100, o = this.baseLineInvertedY + l.globals.padHorizontal + (this.isReversed ? l.globals.gridWidth : 0) - (this.isReversed ? 2 * this.baseLineInvertedY : 0), e = (i - a * this.seriesLen) / 2) : (n = (s = l.globals.gridWidth / this.visibleItems) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100, l.globals.isXNumeric && (l.globals.minXDiff && (s = l.globals.minXDiff / this.xRatio), n = s / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100), r = l.globals.gridHeight - this.baseLineY[this.yaxisIndex] - (this.isReversed ? l.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), t = l.globals.padHorizontal + (s - n * this.seriesLen) / 2), { x: t, y: e, yDivision: i, xDivision: s, barHeight: a, barWidth: n, zeroH: r, zeroW: o } } }, {
                key: "drawBarPaths",
                value: function(t) {
                    var e = t.indexes,
                        i = t.barHeight,
                ...
                value: function(t) {
                    ...
                    var y = { barWidth: o, strokeWidth: h, barXPosition: m, y: s = void 0 === this.series[g][p] || null === this.series[g][p] ? l : l - this.series[g][p] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[g][p] / this.yRatio[this.yaxisIndex] : 0), zeroH: l },
        ...
        X = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e, i, s, a, n) {
                    ...
                    r.animateRect(t, { x: e + s / 2, y: i + a / 2, width: 0, height: 0 }, { x: e, y: i, width: s, height: a }, n, function() { r.animationCompleted() })
                }
        ...
        I = function() {
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    if (this.sliceLabels.forEach(function(t) { k.add(t) }), o.attr({ transform: "translate(".concat(v, ", ").concat(y - 5, ") scale(").concat(x, ")") }), s.attr({ "data:innerTranslateX": v, "data:innerTranslateY": y - 25 }), o.add(k), s.add(o), this.donutDataLabels.show) {
                ...
                value: function(t, e) {
                    ...
                    for (var g = 0; g < t.length; g++) {
                        ...
                        var x = h - o,
                            ...
                            v = a.drawPath({ d: m, stroke: this.lineColorArr instanceof Array ? this.lineColorArr[g] : this.lineColorArr, strokeWidth: this.strokeWidth, fill: b, fillOpacity: i.config.fill.opacity, classes: "apexcharts-pie-area apexcharts-".concat(i.config.chart.type, "-slice-").concat(g) });
            ...
            return s(t, [{
                ...
                value: function(t) {
                    ...
                    if (this.yaxisLabels = this.graphics.group({ class: "apexcharts-yaxis" }), t.forEach(function(t, r) {
                            ...
                            var g = { i: r, realIndex: r, animationDelay: r, initialSpeed: i.config.chart.animations.speed, dataChangeSpeed: i.config.chart.animations.dynamicAnimation.speed, className: "apexcharts-radar", shouldClipToGrid: !1, bindEventsOnPaths: !1, stroke: i.globals.stroke.colors[r], strokeLineCap: i.config.stroke.lineCap },
                                f = null;
                ...
                value: function(t) {
                    ...
                    for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                        ...
                        var P = L - w,
                            ...
                            E = i.drawPath({ d: "", stroke: y, strokeWidth: r, fill: "none", fillOpacity: e.config.fill.opacity, classes: "apexcharts-radialbar-area apexcharts-radialbar-slice-" + m, strokeDashArray: M });
                        if (f.setAttrs(E.node, { "data:angle": P, "data:value": t.series[m] }), e.config.chart.dropShadow.enabled) {
        ...
        D = function() {
            ...
            return s(t, [{ key: "xLabelFormat", value: function(t, e, i) { var s = this.w; if ("datetime" === s.config.xaxis.type && (void 0 === s.config.xaxis.labels.formatter && void 0 === s.config.tooltip.x.formatter)) return new m(this.ctx).formatDate(new Date(e), s.config.tooltip.x.format, !0, !0); return t(e, i) } }, {
                key: "setLabelFormatters",
                value: function() {
                    var t = this.w;
                    return t.globals.xLabelFormatter = function(t) { return t }, t.globals.xaxisTooltipFormatter = function(t) { return t }, t.globals.ttKeyFormatter = function(t) { return t }, t.globals.ttZFormatter = function(t) { return t }, t.globals.legendFormatter = function(t) { return t }, void 0 !== t.config.xaxis.labels.formatter ? t.globals.xLabelFormatter = t.config.xaxis.labels.formatter : t.globals.xLabelFormatter = function(e) {
                        if (d.isNumber(e)) {
        ...
        N = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e, i, s) {
                    ...
                    var u, g;
                    return e.length > 0 ? (u = e[s].unit, g = null, e.forEach(function(t) { "month" === t.unit ? g = "year" : "day" === t.unit ? g = "month" : "hour" === t.unit ? g = "day" : "minute" === t.unit && (g = "hour") }), c = g === u, i = e[s].position, a = e[s].value) : "datetime" === r.config.xaxis.type && void 0 === h && (a = ""), void 0 === a && (a = ""), (0 === (a = a.toString()).indexOf("NaN") || 0 === a.toLowerCase().indexOf("invalid") || a.toLowerCase().indexOf("infinity") >= 0 || n.indexOf(a) >= 0 && !r.config.xaxis.labels.showDuplicates) && (a = ""), { x: i, text: a, isBold: c }
                }
            }, {
                key: "drawYAxisTicks",
                value: function(t, e, i, s, a, n, r) {
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    if (e.globals.timelineLabels.length > 0) {
                        ...
                        e.globals.isBarHorizontal && (r = e.globals.yAxisScale[0].result.reduce(function(t, e) { return t.length > e.length ? t : e }, 0));
                        var o = r;
            ...
            return s(t, [{
                ...
                value: function() {
                    ...
                    for (var n = t.globals.legendFormatter, r = t.config.legend.inverseOrder, o = r ? i.length - 1 : 0; r ? o >= 0 : o <= i.length - 1; r ? o-- : o++) {
                        ...
                        L || (L = t.config.chart.foreColor), C.style.color = L, C.style.fontSize = parseFloat(t.config.legend.fontSize) + "px", C.style.fontFamily = e || t.config.chart.fontFamily, f.setAttrs(C, { rel: o + 1, i: o, "data:default-text": l, "data:collapsed": h || c }), S.appendChild(g), S.appendChild(C);
            ...
            return s(t, [{
                ...
                value: function(t, e, i) {
                    ...
                    var p = f * g,
                        ...
                        b = p * Math.ceil(e / p),
                        m = x;
                    if (r && l > 2) { for (; o.push(m), !((m += p) > b);); return { result: o, niceMin: o[0], niceMax: o[o.length - 1] } }
                    var v = t;
                    (o = []).push(v);
                ...
                value: function(t, e, i) {
                    var s = this,
                        ...
                        n = this.w.globals,
                        r = [];
                    i.forEach(function(t) { t.alreadyExists && (void 0 === r[t.index] && (r[t.index] = []), r[t.index].push(t.index), r[t.index].push(t.similarIndex)) }), n.yAxisSameScaleIndices = r, r.forEach(function(t, e) {
                    ...
                    c.forEach(function(t, e) { t.forEach(function(t, i) { u[e] = Math.min(t.value, u[e]) }) }), d.forEach(function(t, e) { t.forEach(function(t, i) { g[e] = Math.max(t.value, g[e]) }) }), t.forEach(function(t, e) {
                        d.forEach(function(t, i) {
                            var r = u[i],
                                o = g[i];
                            a.chart.stacked && (o = 0, t.forEach(function(t, e) { o += t.value, r !== Number.MIN_VALUE && (r += c[i][e].value) })), t.forEach(function(i, l) { t[l].key === e && (void 0 !== a.yaxis[e].min && (r = "function" == typeof a.yaxis[e].min ? a.yaxis[e].min(n.minY) : a.yaxis[e].min), void 0 !== a.yaxis[e].max && (o = "function" == typeof a.yaxis[e].max ? a.yaxis[e].max(n.maxY) : a.yaxis[e].max), s.setYScaleForIndex(e, r, o)) })
                        })
                    })
                }
            }, {
                ...
                value: function(t, e, i) {
                    ...
                    return e.forEach(function(t, r) {
                        for (var o = 0, l = 0; l < a.length; l++)
                            if (a[l] >= i.xaxis.min) { o = l; break }
                        var h, c, d = s.globals.minYArr[r],
                            u = s.globals.maxYArr[r],
                            g = s.globals.stackedSeriesTotals;
                        s.globals.series.forEach(function(r, l) {
                            var f = r[o];
                            n ? (f = g[o], h = c = f, g.forEach(function(t, e) { a[e] <= i.xaxis.max && a[e] >= i.xaxis.min && (t > c && null !== t && (c = t), r[e] < h && null !== r[e] && (h = r[e])) })) : (h = c = f, r.forEach(function(t, e) {
                                if (a[e] <= i.xaxis.max && a[e] >= i.xaxis.min) {
                                    var n = t,
                                        r = t;
                                    s.globals.series.forEach(function(i, s) { null !== t && (n = Math.min(i[e], n), r = Math.max(i[e], r)) }), r > c && null !== r && (c = r), n < h && null !== n && (h = n)
                                }
        ...
        j = function() {
            function t(i) { e(this, t), this.ctx = i, this.w = i.w, this.scales = new _(i) }
        ...
        U = function() {
            ...
            return s(t, [{
                ...
                value: function(t, e) {
                    ...
                    var v = this.timeScaleArray.map(function(t) { var e = { position: t.position, unit: t.unit, year: t.year, day: t.day ? t.day : 1, hour: t.hour ? t.hour : 0, month: t.month + 1 }; return "month" === t.unit ? n({}, e, { day: 1, value: t.value + 1 }) : "day" === t.unit || "hour" === t.unit ? n({}, e, { value: t.value }) : "minute" === t.unit ? n({}, e, { value: t.value, minute: t.value }) : t });
                ...
                value: function() {
                    ...
                    if (e.config.chart.brush.enabled && "function" != typeof e.config.chart.events.selection) {
                        ...
                        i.forEach(function(e) {
                            ...
                            var s = function() { t.ctx._updateOptions({ chart: { selection: { xaxis: { min: i.w.globals.minX, max: i.w.globals.maxX } } } }, !1, !1) };
                            "function" != typeof i.w.config.chart.events.zoomed && (i.w.config.chart.events.zoomed = function() { s() }), "function" != typeof i.w.config.chart.events.scrolled && (i.w.config.chart.events.scrolled = function() { s() })
    ...
    function Q(t, e) {
        ...
        0 !== t._state ? (t._handled = !0, J._immediateFn(function() {
            ...
            if (null !== i) {
                var s;
                try { s = i(t._value) } catch (t) { return void tt(e.promise, t) }
                K(e.promise, s)
    ...
    function K(t, e) {
        try {
            ...
            if (e && ("object" == typeof e || "function" == typeof e)) { var i = e.then; if (e instanceof J) return t._state = 3, t._value = e, void et(t); if ("function" == typeof i) return void st((s = i, a = e, function() { s.apply(a, arguments) }), t) }
            t._state = 1, t._value = e, et(t)
        } catch (e) { tt(t, e) }
        var s, a
    }

    function tt(t, e) { t._state = 2, t._value = e, et(t) }

    function et(t) {
        2 === t._state && 0 === t._deferreds.length && J._immediateFn(function() { t._handled || J._unhandledRejectionFn(t._value) });
        for (var e = 0, i = t._deferreds.length; e < i; e++) Q(t, t._deferreds[e]);
        t._deferreds = null
    }

    function it(t, e, i) { this.onFulfilled = "function" == typeof t ? t : null, this.onRejected = "function" == typeof e ? e : null, this.promise = i }

    function st(t, e) {
        var i = !1;
        try { t(function(t) { i || (i = !0, K(e, t)) }, function(t) { i || (i = !0, tt(e, t)) }) } catch (t) {
            if (i) return;
            i = !0, tt(e, t)
        }
    }
    J.prototype.catch = function(t) { return this.then(null, t) }, J.prototype.then = function(t, e) { var i = new this.constructor($); return Q(this, new it(t, e, i)), i }, J.prototype.finally = function(t) { var e = this.constructor; return this.then(function(i) { return e.resolve(t()).then(function() { return i }) }, function(i) { return e.resolve(t()).then(function() { return e.reject(i) }) }) }, J.all = function(t) {
    ...
    }, J.resolve = function(t) { return t && "object" == typeof t && t.constructor === J ? t : new J(function(e) { e(t) }) }, J.reject = function(t) { return new J(function(e, i) { i(t) }) }, J.race = function(t) { return new J(function(e, i) { for (var s = 0, a = t.length; s < a; s++) t[s].then(e, i) }) }, J._immediateFn = "function" == typeof setImmediate && function(t) { setImmediate(t) } || function(t) { Z(t, 0) }, J._unhandledRejectionFn = function(t) { "undefined" != typeof console && console && console.warn("Possible Unhandled Promise Rejection:", t) };
    var at, nt, rt = function() {
            ...
            return s(t, [{ key: "getAttr", value: function(t, e) { return parseFloat(t.target.getAttribute(e)) } }, {
                ...
                value: function(t) {
                    ...
                    if (e.target.classList.contains("apexcharts-heatmap-rect")) {
                        ...
                        if (n.tooltipLabels.drawSeriesTexts({ ttItems: i.ttItems, i: o, j: l, shared: !1 }), r.globals.capturedSeriesIndex = o, r.globals.capturedDataPointIndex = l, s = h + n.tooltipRect.ttWidth / 2 + d, a = c + n.tooltipRect.ttHeight / 2 - u / 2, n.tooltipPosition.moveXCrosshairs(h + d / 2), s > r.globals.gridWidth / 2 && (s = h - n.tooltipRect.ttWidth / 2 + d), n.w.config.tooltip.followCursor) {
                ...
                value: function(t) {
                    ...
                    if (s.target.classList.contains("apexcharts-marker")) {
                        ...
                        if (l.tooltipLabels.drawSeriesTexts({ ttItems: a.ttItems, i: e, j: i, shared: !l.showOnIntersect && o.config.tooltip.shared }), "mouseup" === s.type && l.markerClick(s, e, i), o.globals.capturedSeriesIndex = e, o.globals.capturedDataPointIndex = i, n = h, r = c + o.globals.translateY - 1.4 * l.tooltipRect.ttHeight, l.w.config.tooltip.followCursor) {
            ...
            return s(t, [{
                ...
                value: function() {
                    for (var t = this.w, e = this.ttCtx, i = function(i) {
                            ...
                            t.globals.yAxisSameScaleIndices.map(function(e, s) { e.map(function(e, s) { s === i && (a += t.config.yaxis[s].show ? " " : " apexcharts-yaxistooltip-hidden") }) });
            ...
            return s(t, [{ key: "getElTooltip", value: function(t) { return t || (t = this), t.w.globals.dom.baseEl.querySelector(".apexcharts-tooltip") } }, { key: "getElXCrosshairs", value: function() { return this.w.globals.dom.baseEl.querySelector(".apexcharts-xcrosshairs") } }, { key: "getElGrid", value: function() { return this.w.globals.dom.baseEl.querySelector(".apexcharts-grid") } }, {
                ...
                value: function(t) {
                    ...
                    if (this.clientY = c, this.clientX = h, r.globals.capturedSeriesIndex = -1, r.globals.capturedDataPointIndex = -1, c < l.top || c > l.top + l.height) this.handleMouseOut(n);
                        ...
                        if (Array.isArray(this.tConfig.enabledOnSeries) && !r.config.tooltip.shared) { var d = parseInt(n.paths.getAttribute("index")); if (this.tConfig.enabledOnSeries.indexOf(d) < 0) return void this.handleMouseOut(n) }
                    ...
                    if (r.config.legend.tooltipHoverFormatter) {
                        ...
                        for (var u = 0; u < d.length; u++) {
                            var g = d[u],
                                ...
                                b = c(x, { seriesIndex: n ? p : i, dataPointIndex: s, w: r });
        ...
        mt = function(t) {
            function i(t) { var s; return e(this, i), (s = h(this, o(i).call(this, t))).ctx = t, s.w = t.w, s.dragged = !1, s.graphics = new f(s.ctx), s.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], s.clientX = 0, s.clientY = 0, s.startX = 0, s.endX = 0, s.dragX = 0, s.startY = 0, s.endY = 0, s.dragY = 0, s }
            return r(i, bt), s(i, [{
                key: "init",
                value: function(t) {
                    var e = this,
                ...
                value: function(t) {
                    ...
                    if (s.config.yaxis.forEach(function(t, e) { u.push(Math.floor(s.globals.yAxisScale[e].niceMax - n.yRatio[e] * a.startY)), g.push(Math.floor(s.globals.yAxisScale[e].niceMax - n.yRatio[e] * a.endY)) }), a.dragged && (a.dragX > 10 || a.dragY > 10) && h !== c)
                        ...
                        var v, y = null;
                        v = { min: h, max: c }, "xy" !== i && "y" !== i || (y = d.clone(s.config.yaxis)).forEach(function(t, e) { y[e].min = g[e], y[e].max = u[e] }), s.globals.selection = a.selection, "function" == typeof s.config.chart.events.selection && s.config.chart.events.selection(a.ctx, { xaxis: v, yaxis: y })
                    }
                }
            }, {
                key: "panDragging",
    ...
    at = "undefined" != typeof window ? window : void 0, nt = function(e, i) {
        ...
        }, "function" == typeof define && define.amd ? define(function() { return nt(at, at.document) }) : "object" === ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = at.document ? nt(at, at.document) : function(t) { return nt(t, t.document) } : at.SVG = nt(at, at.document),
        function() {
    ...
    return function(t, e) {
        ...
        function() {
            ...
            return s(i, [{
                ...
                value: function() {
                    ...
                    return new J(function(s, a) {
                        ...
                        i.globals.memory.methodsToExec.length > 0 && i.globals.memory.methodsToExec.forEach(function(t) { t.method(t.params, !1, t.context) }), i.globals.axisCharts || i.globals.noData || e.core.resizeNonAxisCharts(), s(e)
                    })
                }
            }, {
                ...
                value: function(e) {
                    var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        ...
                        r = [this];
                    a && (r = this.getSyncedCharts()), this.w.globals.isExecCalled && (r = [this], this.w.globals.isExecCalled = !1), r.forEach(function(a) { var r = a.w; return r.globals.shouldAnimate = s, i || (r.globals.resized = !0, r.globals.dataChanged = !0, s && a.series.getPreviousPaths()), e && "object" === t(e) && (a.config = new w(e), e = y.extendArrayProps(a.config, e), r.config = d.extend(r.config, e), n && (r.globals.lastXAxis = [], r.globals.lastYAxis = [], r.globals.initialConfig = d.extend({}, r.config), r.globals.initialSeries = JSON.parse(JSON.stringify(r.config.series)))), a.update(e) })
                }
            }, {
                key: "updateSeries",
                value: function() {
                ...
                value: function() {
                    var t = this;
                    this.eventList.forEach(function(e) { document.removeEventListener(e, t.documentEvent) });
            ...
            }, { key: "dataURI", value: function() { return new rt(this.ctx).dataURI() } }, { key: "paper", value: function() { return this.w.globals.dom.Paper } }, { key: "parentResizeCallback", value: function() { this.w.globals.animationEnded && this.windowResize() } }, {
                key: "windowResize",
                value: function() {
                    var t = this;
